...
const int DETECTION_EDGES_INDEX = 3;//0-9
const int REAL = 0;
...
main (int argc, char *argv[])
{
  ...
  int* rand_edges[10]; 
  rand_edges[0] = new int[7]{39, 44, 78, 79, 35, 26, 34};
  rand_edges[1] = new int[10]{39, 44, 78, 79, 32, 35, 34, 52, 26, 7};
  rand_edges[2] = new int[13]{39, 44, 78, 79, 35, 1, 26, 32, 15, 52, 34, 21, 7};
  rand_edges[3] = new int[16]{39, 44, 78, 79, 34, 42, 21, 35, 15, 52, 33, 14, 26, 7, 1, 32};
  rand_edges[4] = new int[19]{39, 44, 78, 79, 52, 12, 7, 42, 32, 21, 33, 14, 26, 35, 28, 1, 40, 15, 34};
  rand_edges[5] = new int[22]{39, 44, 78, 79, 7, 52, 40, 35, 14, 26, 15, 21, 41, 22, 42, 34, 1, 45, 28, 32, 33, 12};
  rand_edges[6] = new int[25]{39, 44, 78, 79, 7, 28, 45, 15, 52, 12, 23, 26, 40, 1, 34, 33, 35, 42, 22, 51, 21, 14, 38, 32, 41};
  rand_edges[7] = new int[28]{39, 44, 78, 79, 14, 38, 1, 7, 12, 42, 35, 51, 21, 28, 33, 2, 45, 22, 17, 26, 52, 32, 41, 34, 23, 15, 27, 40};
  rand_edges[8] = new int[31]{39, 44, 78, 79, 42, 32, 40, 52, 23, 45, 28, 34, 38, 15, 9, 1, 26, 5, 33, 14, 17, 2, 41, 12, 51, 22, 27, 7, 21, 18, 35};
  rand_edges[9] = new int[34]{39, 44, 78, 79, 26, 35, 34, 32, 52, 7, 15, 1, 21, 14, 33, 42, 12, 40, 28, 41, 22, 45, 51, 38, 23, 2, 17, 27, 5, 18, 9, 29, 46, 48};
  ...
  p2p.SetExperimentInfo(3, DETECTION_EDGES_INDEX, 2, add_delay_type);
