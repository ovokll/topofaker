...
int add_delay_type = 1;//REAL=1 no use;-1：not add delay; 1: topoFaker
...
main (int argc, char *argv[])
{
  ...
  int* rand_edges[10];
  rand_edges[0] = new int[5]{9, 15, 12, 13, 8};
  rand_edges[1] = new int[6]{13, 26, 8, 9, 12, 15};
  rand_edges[2] = new int[8]{8, 9, 12, 13, 15, 26, 29, 6};
  rand_edges[3] = new int[9]{8, 9, 12, 13, 15, 26, 29, 21, 6};
  rand_edges[4] = new int[11]{8, 9, 12, 13, 15, 26, 29, 16, 21, 5, 6};
  rand_edges[5] = new int[12]{8, 9, 12, 13, 15, 26, 29, 16, 0, 5, 6, 21};
  rand_edges[6] = new int[14]{8, 9, 12, 13, 15, 26, 29, 16, 21, 5, 20, 6, 4, 0};
  rand_edges[7] = new int[15]{8, 9, 12, 13, 15, 26, 29, 4, 5, 0, 21, 2, 20, 16, 6};
  rand_edges[8] = new int[17]{8, 9, 12, 13, 15, 26, 29, 6, 20, 16, 0, 2, 5, 4, 11, 18, 21};
  rand_edges[9] = new int[18]{8, 9, 12, 13, 15, 26, 29, 6, 21, 5, 16, 0, 4, 20, 2, 11, 18, 7};
  ...
  p2p.SetExperimentInfo(1, DETECTION_EDGES_INDEX, 2, add_delay_type);
